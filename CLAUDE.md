...
2. Report any missing items
3. Fix all missing items automatically
4. Only THEN confirm the site is ready to publish

NEVER mark a website as complete if ANY checklist item is missing.
